...
3    | raw    | PREROUTING  | Here you can set a connection to not be handled by the 
connection tracking system.                                                                                                                                                                                     
4    |        |             | This is where the non-locally generated connection tracking
takes place, and is also discussed more in detail in the [_The state machine_](https://www.frozentux.net/iptables-tutorial/iptables-tutorial.html#STATEMACHINE) chapter.                                   
5    | mangle | PREROUTING  | This chain is normally used for mangling packets, i.e.,
changing TOS and so on.                                                                                                                                                                                         
6    | nat    | PREROUTING  | This chain is used for DNAT mainly.
...
8    | mangle | FORWARD     | The packet is then sent on to the
