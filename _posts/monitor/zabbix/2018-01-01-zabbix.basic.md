...
● zabbix-server.service - Zabbix Server
   ...
   Active: activating (auto-restart) (Result: exit-code) since Thu 2018-10-18 15:15:49 CST; 318ms ago
  Process: 35023 ExecStop=/bin/kill -SIGTERM $MAINPID (code=exited, status=1/FAILURE)
  Process: 34969 ExecStart=/usr/sbin/zabbix_server -c $CONFFILE (code=exited, status=0/SUCCESS)
 Main PID: 34971 (code=exited, status=0/SUCCESS)
```
